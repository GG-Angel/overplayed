...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full border-2 cursor-pointer active:opacity-75 disabled:opacity-25 disabled:pointer-events-none transition-all active:scale-[98%]",
  {
    variants: {
