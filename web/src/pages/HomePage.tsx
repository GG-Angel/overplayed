...
import SwipeCardStack from "@/features/swipe/SwipeDeck";
import { useGlobalSwipeMetrics, useSwipeLeaderboard } from "@/api/metrics";
import { useSwipeCarousel } from "@/features/swipe/carousel";
import carouselTracks from "@/assets/carousel-tracks.json";
import z from "zod";
import { LIKED_SONGS_ID, trackSchema } from "@/types";
import { useUserPlaylists } from "@/api/playlists";
...
const CallToAction = () => {
  ...
  const { hasRequestedAccess } = useAccess();
