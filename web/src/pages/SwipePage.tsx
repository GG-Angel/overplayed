import { useTrackPreviewUrl } from "@/api/swipes";
import AudioPlayer from "@/features/swipe/PreviewPlayer";
import { ShortcutsHelp, SwipeProgress } from "@/features/swipe/SwipeControls";
import SwipeButtons from "@/features/swipe/SwipeButtons";
import SwipeCardStack, {
  type SwipeCardController,
  type SwipeDirection,
} from "@/features/swipe/SwipeDeck";
import { useSwipeSession } from "@/features/swipe/SwipeSession";
import { useDebouncedStorage, useKeyboardShortcuts } from "@/hooks";
import { SWIPE_SHORTCUTS } from "@/shortcuts";
import { Check, Shuffle, Undo } from "lucide-react";
import { useCallback, useRef, useState } from "react";
import { useNavigate } from "react-router-dom";
import { storageKeys } from "@/storage";
import { usePreloadSwipePreviews } from "@/features/swipe/hooks";
