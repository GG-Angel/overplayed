import { MessageState } from "@/components/PageState";
import Button from "@/components/ui/Button";
import { Spinner } from "@/components/ui/Spinner";
import { useSubmitSwipes } from "@/features/swipe/hooks";
import { useSwipeSession } from "@/features/swipe/SwipeSession";
import { useConfetti } from "@/hooks";
import { formatPercentage, kaomojis, openExternalUrl } from "@/utils";
import { ExternalLink, Home, Play, RotateCcw } from "lucide-react";
import { useNavigate } from "react-router-dom";

const SubmitPage = () => {
  const navigate = useNavigate();
  const { playlist, session } = useSwipeSession();
